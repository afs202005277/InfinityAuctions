  ...
  <div class="flex-center position-ref full-height">
    ...
    <div class="right-side">
      ...
      <form method="GET" class="deposit" action="{{route('deposit')}}">
        <input id="deposit" placeholder="Deposit Amount €" type="number" name="deposit" required>
      ...
      <form method="GET" class="withdraw" action="{{route('withdraw')}}">
        <input id="withdraw" placeholder="Withdraw Amount €" type="number" name="withdraw" required>
