...
@section('content')
    ...
    <div class="toparea">
        <div class="images">
            <div class="container">
                <img id="expandedImg" src="{{ asset($images[0]['path']) }}" style="width:100%"
    ...
    <div class="below">
        <section class="left">
            ...
            <h3>Share</h3>
            <ul class="link">
                <li><a href="https://instagram.com"><img src={{ asset("img/instagram.svg") }} alt="Instagram logo"></a>
                </li>
                <li><a href="https://facebook.com"><img src={{ asset("img/facebook.svg") }} alt="Facebook logo"></a>
                </li>
        ...
        <section class="right">
            ...
            <p>You're not able to combine shipping if you buy more than one object from the same seller in this
                auction.</p>
            <h4>Customs Information</h4>
            <p>Any other costs or charges such as customs or import duties, customs clearance and handling may also
                apply during the shipment of your lot and will be charged to you by the involved party at a later stage
                if applicable.</p>
        </section>
    </div>
